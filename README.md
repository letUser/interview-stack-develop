...
2. api.orders -> Backend for the applicaiton (written in Python)
3. api.products -> Backend for the applicaiton (written in Python)
...
Webapp, api.orders, and api.products have tests written, webapp uses jest and api.orders & api.products uses pytest.
